...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WsServerMessage_Left&&const DeepCollectionEquality().equals(other.peerId, peerId));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(peerId));
...
/// Create a copy of WsServerMessage
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? peerId = freezed,}) {
