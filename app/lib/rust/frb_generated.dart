...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  RTCStatus dco_decode_rtc_status(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 7:
        return RTCStatus_Error(dco_decode_String(raw[1]));
      default:
  ...
  WsServerMessage dco_decode_ws_server_message(dynamic raw) {
    ...
    switch (raw[0]) {
      ...
      case 3:
        return WsServerMessage_Left(peerId: dco_decode_Uuid(raw[1]));
      case 4:
      ...
      case 6:
        return WsServerMessage_Error(code: dco_decode_u_16(raw[1]));
      default:
        throw Exception("unreachable");
    }
  }
